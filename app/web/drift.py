...
from app.viwe_models.drift import DriftCollection
from . import web
...
def redraw_drift(did):
    with db.auto_commit():
        #超权处理
        # drift = Drift.query.filter(Drift.id==did,Drift.requester.id==current_user.id).first_or_404()
